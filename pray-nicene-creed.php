...
<p><u>Who came down from heaven for us to save us - and for that purpose He was conceived through the power of Holy Spirit and born of the Virgin Mary and became Human.</u></p>
...
$sm->cite(" The following modifications, however, were made at a later time");
$sm->cite(" so as to make the eternal message of inclusivity more clear to those who lack");
$sm->cite(" familiarity with the contextual background of the texts.");
$sm->ct_line(2);
$sm->cite("MODIFICATIONS LATER MADE FOR MODERN-CONTEXT CLARITY OF INCLUSIVITY:");
$sm->ct_line(2);
$sm->cite("\"and became Man\" -> \"and became Human\"");
$sm->ct_link(array()); ?>
...
Modifications were later made, however, to make
the inclusivity more apparent in the modern context.
</p>
